"""
SAOIS CLI - Legacy Entry Point (Now a thin wrapper)
This module delegates to the new simplified CLI in commands.main
All legacy command implementations have been removed.
"""
import sys

# Simply delegate to the new simplified CLI system
def main():
    """Main entry point - delegates to new CLI system."""
